...
namespace VertexAnimationTexture
{
    public class MergeAsLocalMeshBaker : IMeshBaker
    {
        ...
        public MergeAsLocalMeshBaker(GameObject target, bool asNewMesh)
        {
        ...
        public List<BakeMeshData> Sample(float time)
        {
            ...
            Outputs[0].LocalToWorldMatrix = Outputs[0].TransposedWorldToLocalMatrix = Matrix4x4.identity;
            return Outputs;
        }
    }
}