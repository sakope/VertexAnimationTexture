Shader "VertexAnimation/LocalCoord_Matrix_MergedMesh/NormalVisualizer" {
    Properties{
    ...
    SubShader{
        ...
        Pass {
            ...
            vs2ps vert(vsin v) {
                ...
                //This is an object pivot position (if you need).
                float4 pivot = mul(unity_ObjectToWorld, mul(Matrix_M, float4(0,0,0,1)));
